                                            ...
                                            <div class="row justify-content-center">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="card-img-overlay">
                                                        <a class="btn btn-primary btn-flat btn-sm" href="<?=base_url('assets/image/foto_akreditasi/'.$value->foto_akreditasi)?>" data-toggle="lightbox" data-gallery="gallery" data-max-width="700"><i class="fa fa-search-plus"></i></a>
                                                    </div>
                                                </div>
