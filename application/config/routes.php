...
$route['admin/galeri/foto-galeri/(:any)'] = 'admin/showfoto/$1';
$route['admin/galeri/video-galeri/(:any)'] = 'admin/showvideo/$1';
$route['admin/galeri/foto-galeri/tambah-foto/(:any)'] = 'admin/addfoto/$1';
$route['admin/galeri/video-galeri/tambah-video/(:any)'] = 'admin/addvideo/$1';
